...
*******************************************************************************
Our customers use a variety of hardware platforms.  Many of them have policies in place, or are contractually obligated in some way to use the default EFI firmware with no customized secureboot/MOK key injection.  At the same time, customers require the stock CentOS kernel to be patched and supported during a transition period, CIQ apply security backports (supporting older minor versions), or customized options for their workload.
...
https://bitbucket.org/ciqinc/shim-unsigned-x64/src/ciq7/SOURCES/0001-dos2unix-fix-flags-for-RHEL-7.patch
...
*******************************************************************************
We are using the Centos upstream variant 3.10 with minor patches
