...
[TODO: ORG_LEGAL_INFO - needs manual completion]
...
[TODO: EV_CERT_DETAILS - needs manual completion]
...
- PGP key fingerprint: 0310 CFD4 0447 4D14 5072 D3E1 EAFF ECB3 C3AB C924 - PGP key available on keys.openpgp.org
- PGP key URL: https://keys.openpgp.org/vks/v1/by-fingerprint/0310CFD404474D145072D3E1EAFFECB3C3ABC924
...
- PGP key URL: http://keyserver.ubuntu.com/pks/lookup?op=get&search=0xcd8298087bcac022b5ec84fad84a6a5913926d2b
...
*******************************************************************************
- x64: https://github.com/ctrliq/shim-unsigned-x64
- ia32: https://github.com/ctrliq/shim-unsigned-x64"  # ia32 built from same x64 repo
- aa64: https://github.com/ctrliq/shim-unsigned-aarch64
- Build scripts: https://github.com/ctrliq/ciq-shim-build

*******************************************************************************
### What patches are being applied and why:
Mention all the external patches and build process modifications, which are used during your building process, that make your shim binary be the exact one that you posted as part of this application.
*******************************************************************************
N/A - no patches applied to shim 16.1 source.
...
*******************************************************************************
We intend to use the Rocky 8 (based on RHEL 8) GRUB2 source code unmodified, as our projects have no need for bootloader modifications. The Rocky/RHEL Grub versions (and their patches) are what we are using.
...
* October 2023 - NTFS vulnerabilities
  ...
  * CVE-2023-4692
*******************************************************************************
Yes, all CVE fixes are present in our GRUB2 build from Rocky Linux.

Reference: https://git.rockylinux.org/staging/rpms/grub2/-/blob/r8/SPECS/grub2.spec
...
*******************************************************************************
[TODO: GRUB2_SBAT_STATUS - needs manual completion]
...
*******************************************************************************
[TODO: OLD_SHIM_HASHES_STATUS - needs manual completion]
...
- Fixes and enhancements (especially security updates) to continue long-term support of a previous Rocky Linux release.  For example, further backports to the Rocky/RHEL 8.8 kernel (kernel-4.18.0-372) to keep it updated for customers, or FIPS enhancements/restrictions for those that require compliance.
...
*******************************************************************************
[TODO: CHANGES_SINCE_LAST_SIGNING - needs manual completion]

*******************************************************************************
### Shim Version Information
*******************************************************************************
**Shim Version:** 16.1
**SBAT Generation:** [TODO: SBAT_GENERATION - needs manual completion]

*******************************************************************************
### What is the SHA256 hash of your final shim binary?
*******************************************************************************
* SHA256 (shimx64.efi) = dab09cec9d9a7cf7bec88749d32fbe021978e35cfaa0a382483c55e6527e7c89
* SHA256 (shimia32.efi) = 5d5a8ffd715a9a295967f078bf824cfe455b8c9dda390ff340e3f8e4de0f9091
* SHA256 (shimaa64.efi) = b4df771ca898296102915ea76b21be590519c015f39929d95173c34cfc160f6a

**Certificate Information:**
- SHA256 Fingerprint: 8F:B3:73:2A:87:CB:F7:35:BB:E3:19:A3:90:E0:DD:A3:8C:1D:DC:2F:35:B7:40:42:45:89:DA:A9:4D:7C:49:10
- Valid From: Apr 21 15:09:30 2023 GMT
- Valid Until: Apr 20 23:59:59 2048 GMT
...
[TODO: SBAT_FWUPD_X64 - needs manual completion]
```
...
[TODO: SBAT_FWUPD_IA32 - needs manual completion]
```
...
[TODO: SBAT_GRUB_AA64 - needs manual completion]
```

```
objcopy --only-section .sbat -O binary fwupdaa64.efi /dev/stdout
[TODO: SBAT_FWUPD_AA64 - needs manual completion]
```
...
*******************************************************************************
Rocky Linux / GRUB 2.02:
```
{'el8': 'efi_netfs efifwsetup efinet lsefi lsefimmap connectefi backtrace chain usb usbserial_common usbserial_pl2303 usbserial_ftdi usbserial_usbdebug keylayouts at_keyboard all_video boot blscfg cat configfile cryptodisk echo ext2 fat font gcry_rijndael gcry_rsa gcry_serpent gcry_sha256 gcry_twofish gcry_whirlpool gfxmenu gfxterm gzio halt http increment iso9660 jpeg loadenv loopback linux lvm luks mdraid09 mdraid1x minicmd net normal part_apple part_msdos part_gpt password_pbkdf2 png reboot regexp search search_fs_uuid search_fs_file search_label serial sleep syslinuxcfg test tftp video xfs', 'el9': 'efi_netfs efifwsetup efinet lsefi lsefimmap connectefi backtrace chain tpm usb usbserial_common usbserial_pl2303 usbserial_ftdi usbserial_usbdebug keylayouts at_keyboard all_video boot blscfg cat configfile cryptodisk echo ext2 f2fs fat font gcry_rijndael gcry_rsa gcry_serpent gcry_sha256 gcry_twofish gcry_whirlpool gfxmenu gfxterm gzio halt http increment iso9660 jpeg loadenv loopback linux lvm luks luks2 mdraid09 mdraid1x minicmd net normal part_apple part_msdos part_gpt password_pbkdf2 pgp png reboot regexp search search_fs_uuid search_fs_file search_label serial sleep syslinuxcfg test tftp version video xfs zstd'}
```
...
*******************************************************************************
We use Rocky Linux - GRUB 2.02-150
...
*******************************************************************************
[TODO: CONTRIBUTIONS - needs manual completion]
